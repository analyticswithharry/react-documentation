...
Skip to main contentRe-watch the latest React Native Keynote from React Conf 2025Follow @reactnativeStar

# React Native

## Learn once, write anywhere.Get StartedLearn the Basics

# Create native apps for Android, iOS, and more using React

### React Native brings the best parts of developing with React to native development.
It's a best-in-class JavaScript library for building user interfaces.index.js
...
### Watch talks by the React team and learn how to get the most out of React Native.
Find the latest on Bluesky and X.
...
# Welcome to the React Native communityGet Started